...
#include "ShooterZombieCharacter.generated.h"

class USoundCue;

UCLASS(ABSTRACT)
class PROTOTYPE_API AShooterZombieCharacter : public AShooterBaseCharacter
{
	GENERATED_BODY()
...
public:
	...
	AShooterZombieCharacter(const class FObjectInitializer& ObjectInitializer);
